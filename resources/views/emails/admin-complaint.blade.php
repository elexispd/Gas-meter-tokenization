...
<body>
    <div class="container">
        ...
        <h3 style="text-align: center;">A User Raised A Complaint</h3>
        <p>Hello Admin ,</p>
        <div class="info">
            <p>A user recently raised a complaint on our platform. Please do get back to him/her as soon as possible</p>
        </div>
