...
<body>
    <div class="container">
        ...
        <h3 style="text-align: center;">Your Voice Will Be Heard</h3>
        <p>Hello {{ $name}} ,</p>
        <div class="info">
            <p>You recently raised a complaint on our platform. Be rest assured that we will get back get back to you as soon as possible</p>
        </div>
