    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <span class="badge badge-info p-3">N/B: Default password is the tenant12345 <i class="fa fa-exclamation-circle"></i></span>
                    </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Register Tenant </h3>
                        </div>

                        <form id="quickForm" method="POST" action="{{ route('user.tenant.store') }}">
                            @csrf
                            <div class="card-body">
